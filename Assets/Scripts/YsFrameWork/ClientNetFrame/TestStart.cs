    ...
    class TestStart
    {
        ...
        StartConnect:
            ...
            while (true)
            {
                ...
                //NetCore.Instance.Send(Protocols.Protocol.LOGIN_CREQ, 0, (int)Protocols.Protocol.Command.RegisterRequest, null);
            }
        }
        ...
        static void TestRegister()
        {
            ...
            NetCore.Instance.Send(Protocols.Protocol.LOGIN_CREQ, 0, (int)Protocols.Protocol.Command.RegisterRequest, accountInfo);
        }
        ...
        static void TestLogin()
        {
            ...
            NetCore.Instance.Send(Protocols.Protocol.LOGIN_CREQ, 0, (int)Protocols.Protocol.Command.LoginRequest, accountInfo);
        }
    }
}

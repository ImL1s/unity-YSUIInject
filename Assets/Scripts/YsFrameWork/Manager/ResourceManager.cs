...
namespace YSFramework
{
	...
	public class ResourceManager : BaseManager<ResourceManager>
    {
        ...
        public void LoadCoroutine(string _path, Action<UnityEngine.Object> _loaded)
        {
            ...
            if (null != _assetInfo)
                UnityCoroutine.Instance.StartCoroutine(_assetInfo.GetCoroutineObject(_loaded));
        }
        #endregion
        ...
        public void LoadAsync(string _path, Action<UnityEngine.Object> _loaded, Action<float> _progress)
        {
            AssetInfo _assetInfo = GetAssetInfo(_path, _loaded);
            if (null != _assetInfo)
                UnityCoroutine.Instance.StartCoroutine(_assetInfo.GetAsyncObject(_loaded, _progress));
        }
        #endregion
